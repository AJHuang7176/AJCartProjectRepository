    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult AddCar(string fPId)
        {
            ...
            if (currentCar == null)
            {
                ...
                orderDetail.fOrderGuid = product.fImg;
        ...
        //增加產品數量
        public ActionResult AddQty(string fPId)
        {
        ...
        //減少產品數量
        public ActionResult ReduceQty(string fPId)
        {
            string fUserId = (Session["Member"] as tMember).fUserId;
            ...
            if (currentCar != null && currentCar.fQty != 0)
            {
                currentCar.fQty -= 1;
            }

            if(currentCar.fQty == 0)
            {
                DeleteCar(currentCar.fId);
            }
